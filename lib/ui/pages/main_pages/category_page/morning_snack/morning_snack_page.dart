...
class _MorningSnackState extends State<MorningSnack> {
  List<Dish> dishes = [];
  List<dynamic> feeds = [];
  //late FeedConstructor constructor;
  @override
  void initState() {
    super.initState();
    /*constructor = FeedConstructor(jsonPath: 'assets/json/morning_snack.json');
    setState(() {
      feeds = constructor.getFeeds();
    });*/
  ...
  Widget build(BuildContext context) {
    //FeedConstructor constructor = FeedConstructor(jsonPath: 'assets/json/morning_snack.json');
